...
import { Users, Bookmark, CheckCircle, Mail, Phone, Globe, MapPin, Briefcase, Building2 } from "lucide-react";
...
const CompanyProfile = () => {
  ...
  // ── UPDATE PROFILE ──
  const updateProfile = async (payload: typeof form) => {
  ...
  const initials = company?.companyName
    ? company.companyName.split(" ").map((w: string) => w[0]).join("").slice(0, 2).toUpperCase()
    : "TC";
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl overflow-hidden bg-white border border-gray-100 shadow-sm">
        ...
        <div className="px-6 pb-6">
          <div className="flex items-end justify-between -mt-12 mb-4">
            {/* Avatar */}
            <div className="w-24 h-24 rounded-2xl bg-white border-4 border-white shadow-lg flex items-center justify-center text-[#6c63d4] font-bold text-2xl">
              {initials}
            </div>
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl bg-[#6c63d4] text-white text-sm font-semibold hover:bg-[#5a4fcf] transition-colors"
            >
              Edit Profile
            </button>
          </div>
      ...
      <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-6">
        ...
        {company?.description ? (
          ...
          <p className="text-sm text-gray-400 italic">No description added yet. Click "Edit Profile" to add one.</p>
        )}
      </div>
